...
const FullScreenNav = () => {
  ...
  return (
    <div id='fullscreennav' className='z-50 absolute bg-black pt-10 max-sm:pt-4 max-md:pt-6 flex justify-center items-center text-white h-screen w-screen overflow-hidden'>
    <Link to='/' className='w-30 max-sm:w-16 max-md:w-20 absolute top-0 left-0 m-2 max-sm:m-1 max-md:m-1.5'>
        ...
        <Link to='/'>
        <RxCross1 id='crossIcon' className='absolute top-0 hover:text-[#D3FD50] right-0 max-sm:!w-16 max-sm:!h-16 max-md:!w-20 max-md:!h-20' size={150} />
        </Link>

    <div id='allLinks' className='bg-green-500 overflow-hidden w-full h-[70%] max-sm:h-[75%] max-md:h-[72%] flex flex-col justify-around text-8xl max-sm:text-3xl max-md:text-5xl uppercase font-[font2] items-center'>
      ...
      className='w-full bg-black cursor-pointer h-full flex justify-center relative p-5 max-sm:p-2 max-md:p-3 items-center'>
      <div className="flatLine w-full h-[1px] absolute top-0 bg-white"></div>

        <h1 className='split'>Projects</h1>  
        
         
          <div ref={marq} className='bg-[#D3FD50] z-10 opacity-0 font-[font2] flex text-black absolute left-0 align-middle top-0 pt-5 max-sm:pt-2 max-md:pt-3 h-full w-[200vw] animateMarque justify-around item-center'>
            <img className='h-20 w-65 max-sm:h-10 max-sm:w-32 max-md:h-14 max-md:w-40 rounded-full' src="assets/NavImg.jpg" alt="" />
          <div>
            Pour tout voir
          </div>
             <img className='h-20 w-65 max-sm:h-10 max-sm:w-32 max-md:h-14 max-md:w-40 rounded-full' src="assets/NavImg.jpg" alt="" />
      ...
      className='w-full bg-black cursor-pointer h-full flex justify-center relative p-5 max-sm:p-2 max-md:p-3 items-center'>
        ...
        <h1 className='split'>Agence</h1>
          <div ref={marq1} className='bg-[#D3FD50] z-10 opacity-0 font-[font2] flex text-black absolute left-0 align-middle top-0 pt-5 max-sm:pt-2 max-md:pt-3 h-full w-[200vw] animateMarque justify-around item-center'>
            <img className='h-20 w-65 max-sm:h-10 max-sm:w-32 max-md:h-14 max-md:w-40 rounded-full' src="assets/NavImg.jpg" alt="" />
          <div>
            Pour tout savoir
          </div>
      ...
      <div className="flatLine w-[100vw] h-[1px] left-0 absolute top-0 bg-white"></div>
        <h1 className='split'>contact</h1>
          <div ref={marq2} className='bg-[#D3FD50] z-10 opacity-0 font-[font2] flex text-black absolute left-0 align-middle top-0 pt-5 max-sm:pt-2 max-md:pt-3 h-full w-[200vw] animateMarque justify-around item-center'>
            <img className='h-20 w-65 max-sm:h-10 max-sm:w-32 max-md:h-14 max-md:w-40 rounded-full' src="assets/NavImg.jpg" alt="" />
          <div>
            Pour unovoir un
          </div>
      ...
      <div className="flatLine w-full h-[1px] absolute left-0 top-0 bg-white"></div>
        <h1 className='split'>blog</h1>
         <div ref={marq3} className='bg-[#D3FD50] z-10 opacity-0 font-[font2] flex text-black absolute left-0 align-middle top-0 pt-5 max-sm:pt-2 max-md:pt-3 h-full w-[200vw] animateMarque justify-around item-center'>
            <img className='h-20 w-65 max-sm:h-10 max-sm:w-32 max-md:h-14 max-md:w-40 rounded-full' src="assets/NavImg.jpg" alt="" />
          <div>
            liar lies articles
          </div>
    ...
    <div className='absolute bg-black items-baseline w-full uppercase flex max-sm:flex-col max-md:flex-col max-sm:items-start max-md:items-start max-sm:gap-3 max-md:gap-4 justify-between ml-5 mr-5 max-sm:ml-2 max-sm:mr-2 max-md:ml-3 max-md:mr-3 mb-5 max-sm:mb-2 max-md:mb-3 bottom-0 left-0 font-[font1]'>
      <CurrentTime></CurrentTime>
      <div className='flex text-[12px] max-sm:text-[8px] max-md:text-[10px] gap-5 max-sm:gap-2 max-md:gap-3 max-sm:flex-wrap max-md:flex-wrap'>
      ...
      <div className='bg-black flex justify-baseline text-[35px] max-sm:text-[20px] max-md:text-[25px] items-center gap-0 mr-15 max-sm:mr-0 max-md:mr-5'>
